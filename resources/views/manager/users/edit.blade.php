                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @endif
                                    <p class="txt-warning">оставьте это поле пустым если не хотите изменять пароль </p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12 m-b-20">
                                <div class="checkbox checkbox-primary">
                                    {{ Form::checkbox('status', 1, old('status', $user->status), ['id' => 'status']) }}
                                                        ...
                                                        <div class="col">
                                                            <div class="form-group m-t-15">
                                                                @foreach($rp->roles as $role)
                                                                    <div class="checkbox checkbox-primary">
                                                                        {{ Form::checkbox($rp->prefix.'_'.$role->alias, 1, old($rp->prefix.'_'.$role->alias, !empty($role_array[$rp->prefix.'_'.$role->alias]) ? $role_array[$rp->prefix.'_'.$role->alias] : 0) == 1, ['id' => $rp->prefix.'_'.$role->alias]) }}
