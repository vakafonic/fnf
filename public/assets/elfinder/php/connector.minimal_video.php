...
$opts = array(
    ...
    'roots' => array(
        ...
        array(
            ...
            'path'          => '../../../storage/video/',                 // path to files (REQUIRED)
            'URL'           => '/storage/video/', // URL to files (REQUIRED)
            'trashHash'     => 't1_Lw',                     // elFinder's hash of trash folder
            'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
            'uploadDeny'    => array('all'),                // All Mimetypes not allowed to upload
            'uploadAllow'   => array('video/mp4'), // Mimetype `image` and `text/plain` allowed to upload // , 'video/3gpp', 'video/quicktime', 'video/x-msvideo', 'video/x-ms-wmv'
        ...
        array(
            'id'            => '1',
            'driver'        => 'Trash',
            'path'          => '../../../storage/video/.trash/',
            'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '/../../../storage/video/.trash/.tmb/',
            'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
            'uploadDeny'    => array('all'),                // Recomend the same settings as the original volume that uses the trash
            'uploadAllow'   => array('video/mp4'), // Same as above
